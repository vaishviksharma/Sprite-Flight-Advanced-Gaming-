...
export class Player {
    ...
    checkCollision() {
        const normalHit = document.getElementById('normalHit');
        this.game.enemies.forEach(enemy => {
            if (enemy.x < this.x + this.width && 
                ...
                if(this.currentState === this.states[4] || this.currentState === this.states[5]){
                    this.game.score++;
                    this.game.floatingMessages.push(new FloatingMessages('+1', enemy.x, enemy.y, 176, 58)); 
                } else {
                    this.setState(6, 0);
                    this.game.lives--;
